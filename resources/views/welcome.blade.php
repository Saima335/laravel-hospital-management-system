                    ...
                    <div class="collapse navbar-collapse" id="navbarSupport">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item row">
                                ...
                                {{--@auth
                                <!-- <a href="{{ url('/patient/home') }}" class="btn btn-primary ml-lg-3">Home</a> -->
                                @else--}}
                                <!-- <a href="{{ route('login') }}" class="btn btn-primary ml-lg-3">Log in</a> -->
                                <div class="dropdown">
                                    <button class="btn btn-primary ml-lg-3 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      Log in
                                    </button>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a class="dropdown-item" href="{{ route('login') }}">Register as Patient</a>
                                      <a class="dropdown-item" href="#">Register as Admin</a>
                                    </div>
                                  </div>
                                @endif--}}
                                {{--@endauth--}}
                ...
                <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
                    ...
                    <div class="item">
                        <div class="card-doctor">
                            <div class="header">
                                <img height="300px" src="doctorimage/{{$doctor->image}}" alt="Doctor">
                                <div class="meta">
