 ...
 <!-- <script src="../admin1/assets/vendors/js/vendor.bundle.base.js"></script> -->
    ...
    <script src="../admin1/assets/js/jquery.cookie.js" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="../admin1/assets/js/off-canvas.js"></script>
    <script src="../admin1/assets/js/hoverable-collapse.js"></script>
    <script src="../admin1/assets/js/misc.js"></script>
    <script src="../admin1/assets/js/settings.js"></script>
    <script src="../admin1/assets/js/todolist.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="../admin1/assets/js/dashboard.js"></script>
