...
<head>
    ...
    <!-- <title>{{ config('app.name', 'LaravelLaboratory') }}</title> -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li><a href="{{ route('laboratory.logout') }}">Logout</a></li>
                        @endif--}}
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if(!Auth::guard('laboratory')->check())
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('laboratory.login') }}">{{ __('Login') }}</a>
                                </li>
                                <li class="nav-item">
                            ...
                            @if (Route::has('register'))
                                <!-- <li class="nav-item">
                                    <a class="nav-link" href="{{ route('laboratory.register') }}">{{ __('Register') }}</a>
                                </li> -->
                        ...
                        @endif
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div style="background-color:white; color:black;" class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a style="background-color:white; color:black;" class="dropdown-item" href="{{ route('laboratory.logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        {{ __('Logout') }}
                                    </a>

                                    <form id="logout-form" action="{{ route('laboratory.logout') }}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                                </div>
                            </li>
